      ...
      <div class="container-fluid">
        <a href="home" class="navbar-brand font-weight-bold p-0">
          <div class="d-flex align-items-center">
            <div>
              <img src="../img/zl.png" width="180" style="border-radius: 130%" />
            </div>
        ...
        <div id="navbarSupportedContent" class="collapse navbar-collapse">
          <ul class="navbar-nav ml-auto d-lg-flex align-items-lg-center">
            ...
            <?php if (!(isset($_SESSION['user_type']) && $_SESSION['user_type'] == 'sponsor')) { ?>
              <li class="nav-item"><a href="disease" class="nav-link font-weight-bold px-lg-3 py-lg-4">Disease </a>
              </li>
    ...
    <div class="container py-5">
      <div class="row">
        <div class="col-lg-8 col-md-6 mb-4">
          <h5 class="lined lined-dark color-header mb-3 color-header">Zoo Management System</h5>
          <p class="text-muted text-small">Wonderful Creatures</p>
          <p class="text-muted text-small">Anyone Can Visit</p>
        </div>
        <div class="col-lg-4 col-md-6 mb-4">
          <h5 class="lined lined-dark mb-3 color-header">Our Location</h5>
          <h6>Zoo Management System</h6>
          <p class="text-muted mb-0 text-small">Saveetha Zoo</p>
          <p class="text-muted mb-0 text-small">Thandalam</p>
          <p class="text-muted mb-4 text-small">Mobile + 91 9876543210 </p>
        </div>
        <div class="col-lg-4 col-md-6 mb-4">
